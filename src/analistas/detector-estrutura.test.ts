...
describe('detectorEstrutura', () => {
    it('detecta monorepo incompleto (sem pasta packages/)', () => {
        ...
        expect(Array.isArray(ocorrencias) && ocorrencias.some((o: any) => o.tipo === 'estrutura-monorepo-incompleto')).toBe(true);
    });
    ...
    it('detecta estrutura incompleta (pages/ sem api/)', () => {
        ...
        const ocorrencias = detectorEstrutura.aplicar('', '', undefined, '', contexto as any);
        expect(Array.isArray(ocorrencias) && ocorrencias.some((o: any) => o.tipo === 'estrutura-incompleta')).toBe(true);
    });
    ...
    it('detecta estrutura mista (src/ e packages/)', () => {
        ...
        const ocorrencias = detectorEstrutura.aplicar('', '', undefined, '', contexto as any);
        expect(Array.isArray(ocorrencias) && ocorrencias.some((o: any) => o.tipo === 'estrutura-mista')).toBe(true);
    });
    ...
    it('detecta muitos arquivos na raiz', () => {
        ...
        const ocorrencias = detectorEstrutura.aplicar('', '', undefined, '', contexto as any);
        expect(Array.isArray(ocorrencias) && ocorrencias.some((o: any) => o.tipo === 'estrutura-suspeita')).toBe(true);
    });
    ...
    it('detecta sinais de backend', () => {
        ...
        const ocorrencias = detectorEstrutura.aplicar('', '', undefined, '', contexto as any);
        expect(Array.isArray(ocorrencias) && ocorrencias.some((o: any) => o.tipo === 'estrutura-backend')).toBe(true);
    });
    ...
    it('detecta sinais de frontend', () => {
        ...
        const ocorrencias = detectorEstrutura.aplicar('', '', undefined, '', contexto as any);
        expect(Array.isArray(ocorrencias) && ocorrencias.some((o: any) => o.tipo === 'estrutura-frontend')).toBe(true);
    });
    beforeEach(() => {
