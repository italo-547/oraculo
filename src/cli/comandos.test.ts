...
vi.mock('./comando-diagnosticar.js', () => ({ comandoDiagnosticar: vi.fn(() => new Command('diagnosticar')) }));
...
vi.mock('./comando-reestruturar.js', () => ({ comandoReestruturar: vi.fn(() => new Command('reestruturar')) }));
vi.mock('./comando-atualizar.js', () => ({ comandoAtualizar: vi.fn(() => new Command('atualizar')) }));
