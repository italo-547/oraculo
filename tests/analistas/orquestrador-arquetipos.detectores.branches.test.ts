...
import type { ResultadoDeteccaoArquetipo } from '../../src/tipos/tipos.js';
...
describe('orquestrador-arquetipos – ramos adicionais', () => {
  it('apenas penalidades: desempata por missingRequired quando ratio e forb empatam', async () => {
    ...
    vi.mock('../../src/analistas/detectores/detector-node.js', () => ({
      detectarArquetipoNode: () => [],
    }));
    vi.mock('../../src/analistas/detectores/detector-java.js', () => ({
      detectarArquetipoJava: () => [],
    }));
    vi.mock('../../src/analistas/detectores/detector-kotlin.js', () => ({
      detectarArquetipoKotlin: () => [],
    }));
    vi.mock('../../src/analistas/detectores/detector-xml.js', () => ({
      detectarArquetipoXML: () => [],
    }));
    vi.mock('../../src/analistas/deteccao/pontuador.js', () => ({
      pontuarTodos: () => [
        {
    ...
    const { detectarArquetipo } = await import('../../src/analistas/orquestrador-arquetipos.js');
