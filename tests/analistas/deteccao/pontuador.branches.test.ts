...
vi.mock('../../src/analistas/arquetipos-defs.js', () => ({
  ARQUETIPOS: [
    {
...
vi.mock('../../src/analistas/detector-dependencias.js', () => ({
...
describe('pontuador – branches e explicações', () => {
  ...
  it('gera explicação por faixas e inclui fullstack como candidato adicional quando há sinais mistos', async () => {
    const { pontuarTodos } = await import('../../src/analistas/deteccao/pontuador.js');
    const arquivos = [
