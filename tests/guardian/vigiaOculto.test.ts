...
import { vigiaOculta } from '../../src/guardian/vigiaOculto.js';

vi.mock('../../src/guardian/registros.js', () => ({
...
describe('vigiaOculta', () => {
  ...
  it('executa sem lançar erro (mock básico)', async () => {
    const { carregarRegistros } = await import('../../src/guardian/registros.js');
  ...
  it('detecta arquivos corrompidos, loga e faz reset automático', async () => {
    const { carregarRegistros, salvarRegistros } = await import('../../src/guardian/registros.js');
