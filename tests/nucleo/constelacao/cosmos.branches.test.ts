...
describe('cosmos deepMerge e overrides', () => {
  ...
  it('prioridade: arquivo < env < cli', async () => {
    ...
    const { inicializarConfigDinamica, config } = await import(
      '../../src/nucleo/constelacao/cosmos.js'
    );
    ...
    const { aplicarConfigParcial } = await import('../../src/nucleo/constelacao/cosmos.js');
